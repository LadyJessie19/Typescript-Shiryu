...
/* Usando ? podemos indicar que a propriedade não é obrigatória na hora da ciração dos dados */

/* Devemos usar narrowing para trabalhar com dados opcionais */
...
const u1:IUser = { email: "matheus@gmail.com" }

const u2:IUser = { email: "jessie@gmail.com", role: "Game Master" }
...
/* Essas propriedades possuem valores constantes */
...
// fusca.wheels = 4 - It's not possible
// fusca.brand = "MinU" - It's possible
// console.log(fusca)

/* -5- Index Signature */

/* Utilizamos quando não sabemos o nome das chaves, mas sabemos os tipos de um objeto ou array */

/* Mais segurança */

/* Essa propriedade chama as chaves de "fulano" */
